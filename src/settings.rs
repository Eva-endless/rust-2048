...
pub struct Settings {
    ...
    pub undo_rect: [f64; 4],
    pub ai_button_rect: [f64; 4],
    pub restart_button_rect: [f64; 4],
    pub back_button_rect: [f64; 4],
    pub label_color: [f32; 3],
    pub button_color: [f32; 3],
    pub text_dark_color: [f32; 3],
    pub text_light_color: [f32; 3],
    pub score_background_colors: Vec<[f32; 3]>,
}
...
impl Settings {
    ...
    fn from_settings_in_json<'a>(s: &'a SettingsInJson) -> Settings {
        ...
        Settings {
            ...
            score_background_colors: vec![
                [255.0/255.0, 253.0/255.0, 245.0/255.0],
                [255.0/255.0, 248.0/255.0, 200.0/255.0],
                [255.0/255.0, 240.0/255.0, 150.0/255.0],
                [255.0/255.0, 230.0/255.0, 100.0/255.0],
                [255.0/255.0, 220.0/255.0, 80.0/255.0],
                [255.0/255.0, 200.0/255.0, 60.0/255.0],
                [255.0/255.0, 180.0/255.0, 40.0/255.0],
            ],
        }
    }
}
...
impl SettingsInJson {
    pub fn default_settings() -> SettingsInJson {
        ...
        SettingsInJson {
            ...
            comment1_offset_y: 100.0,
            comment2_offset_y: 135.0,
            board_padding: 20.0,
            board_offset_y: 240.0,
            tile_width: 4,
            tile_height: 4,
            tile_size: 100.0,
            tile_padding: 20.0,
            ...
            best_rect: vec![380.0, 20.0, 120.0, 56.0],
            score_rect: vec![240.0, 20.0, 120.0, 56.0],
